...
(function() {
    ...
    function Ut(e, t) {
        return t = t != null ? t : {},
        Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : Ja(Object(t)).forEach(function(a) {
    ...
    function wr(e, t) {
        ...
        if (a != null) {
            var i = [], o = !0, u = !1, s, d;
            try {
                for (a = a.call(e); !(o = (s = a.next()).done) && (i.push(s.value),
                !(t && i.length === t)); o = !0)
                    ;
            } catch (p) {
                u = !0,
    ...
    function Rr(e, t) {
        ...
        function f(v) {
            ...
            u; )
                try {
                    if (a = 1,
                    i && (o = v[0] & 2 ? i.return : v[0] ? i.throw || ((o = i.return) && o.call(i),
                    0) : i.next) && !(o = o.call(i, v[1])).done)
                        return o;
                    switch (i = 0,
                    o && (v = [v[0] & 2, o.value]),
                    v[0]) {
                    ...
                    default:
                        if (o = u.trys,
                        !(o = o.length > 0 && o[o.length - 1]) && (v[0] === 6 || v[0] === 2)) {
                            u = 0;
                            continue
                        }
    ...
    function Wt(e) {
        ...
        if (e.params.botnet && t.set("botnet", "true"),
        e.params._debugSitekeyOverrides && (e.params._debugSitekeyOverrides.offlabel !== "default" && t.set("offlabel", e.params._debugSitekeyOverrides.offlabel),
        ...
        e.params._debugSitekeyOverrides.offlabelShowPrivacy && e.params._debugSitekeyOverrides.offlabelShowPrivacy !== "default" && t.set("offlabel_show_privacy", e.params._debugSitekeyOverrides.offlabelShowPrivacy),
        e.params._debugSitekeyOverrides.offlabelShowHelp && e.params._debugSitekeyOverrides.offlabelShowHelp !== "default" && t.set("offlabel_show_help", e.params._debugSitekeyOverrides.offlabelShowHelp)),
        e.params._debugForceLoopFeedback && t.set("force_loop_feedback", "true"),
        e.params["offlabel-show-privacy"] !== void 0 && t.set("offlabel_show_privacy", String(e.params["offlabel-show-privacy"])),
        e.params["offlabel-show-help"] !== void 0 && t.set("offlabel_show_help", String(e.params["offlabel-show-help"])),
    ...
    function _t(e, t, a) {
        var i, o = "https://challenges.cloudflare.com", u = (i = a == null ? void 0 : a.origin) !== null && i !== void 0 ? i : o;
        if (t) {
            var s;
    ...
    var Jt = function(t) {
        var a, i, o, u, s = window.innerWidth < 400, d = t.state !== gt.FailureFeedbackCode && (t.state === gt.FailureFeedback || t.state === gt.FailureHavingTroubles || !t.errorCode), p = q(qa, (a = (o = t.displayLanguage) === null || o === void 0 ? void 0 : o.toLowerCase()) !== null && a !== void 0 ? a : "nonexistent"), f = q(za, (i = (u = t.displayLanguage) === null || u === void 0 ? void 0 : u.toLowerCase()) !== null && i !== void 0 ? i : "nonexistent");
        return s ? ja({
    ...
    function jr(e, t, a) {
        return t = Ae(t),
        zr(e, Qe() ? Reflect.construct(t, a || [], Ae(e).constructor) : t.apply(e, a))
    }
    function Gr(e, t) {
        if (!P(e, t))
    ...
    var Kr = (function(e) {
        ...
        function t(a, i) {
            Gr(this, t);
            var o;
            return o = jr(this, t, [a]),
            Le(o, "code", void 0),
            o.name = "TurnstileError",
            o.code = i,
            o
        }
        return t
    ...
    function xt(e, t) {
        ...
        try {
            for (var u = Object.getOwnPropertySymbols(e)[Symbol.iterator](), s; !(a = (s = u.next()).done); a = !0) {
                var d = s.value, p, f = (p = Object.getOwnPropertyDescriptor(e, d)) === null || p === void 0 ? void 0 : p.value;
                if (t(f))
                    return f
            }
        } catch (v) {
    ...
    function et() {
        ...
        for (var a = document.querySelectorAll("script"), i = 0, o; o = a[i]; i++)
            if (P(o, HTMLScriptElement) && e.test(o.src))
                return o
    }
    function Qr() {
        var e = et();
        ...
        var o = t.split("?");
        return o.length > 1 && (i.params = new URLSearchParams(o[1])),
        i
    }
    function $() {
        return Date.now()
    ...
    var ea = function(t, a, i, o, u) {
        ...
        I.append("rayId", i),
        I.append("sitekey", (s = t.params.sitekey) !== null && s !== void 0 ? s : ""),
        I.append("rcV", (d = t.rcV) !== null && d !== void 0 ? d : ""),
        I.append("cfChlOut", (p = t.cfChlOut) !== null && p !== void 0 ? p : ""),
        I.append("cfChlOutS", (f = t.cfChlOutS) !== null && f !== void 0 ? f : ""),
        I.append("mode", (v = t.mode) !== null && v !== void 0 ? v : ""),
        I.append("errorCode", String((E = t.errorCode) !== null && E !== void 0 ? E : 0)),
        I.append("frMd", o),
        I.append("displayLanguage", (C = t.displayLanguage) !== null && C !== void 0 ? C : "");
        try {
            if (typeof navigator != "undefined" && typeof navigator.sendBeacon == "function" && navigator.sendBeacon(A, I))
                return !0
        } catch (U) {
    ...
    function ia(e) {
        ...
        try {
            for (var s = Object.getOwnPropertySymbols(e)[Symbol.iterator](), d; !(i = (d = s.next()).done); i = !0) {
                var p = d.value, f, v = Zr((f = Object.getOwnPropertyDescriptor(e, p)) === null || f === void 0 ? void 0 : f.value);
                if (v)
                    return v
            }
        } catch (E) {
    ...
    function en(e) {
        ...
        return a.set(Qa, window.location.origin),
        t.hash = a.toString(),
        t.toString()
    }
    var Gt = function(t, a, i, o, u) {
        var s, d, p = aa(t), f = _t(a.params, !1, o), v = "h/".concat("g", "/"), E = en("".concat(f, "/cdn-cgi/challenge-platform/").concat(v, "feedback-reports/").concat(Ze(t), "/").concat(a.displayLanguage, "/").concat((d = a.params.theme) !== null && d !== void 0 ? d : a.theme, "/").concat(i));
        if (Ue(a),
        window.top !== window.self) {
            var C = window.open(E, "_blank");
            if (C) {
                a.feedbackPopupOrigin = De(E),
                a.feedbackPopup = C;
                var A = window.setInterval(function() {
                    C.closed && (window.clearInterval(A),
                    a.feedbackPopupCloseCheck = void 0,
                    u == null || u())
                }, 500);
        ...
        R.style.background = "rgba(0,0,0,0.4)";
        var N = document.createElement("div");
        N.className = "cf-wrapper-turnstile-feedback",
        ...
        var ge = function() {
          ...
          , Z = function() {
            ...
            (ee = R.parentNode) === null || ee === void 0 || ee.removeChild(R),
            u == null || u()
        }
          , D = document.createElement("iframe");
        D.id = p,
        D.setAttribute("src", E),
        D.setAttribute("title", "Turnstile feedback report"),
        D.setAttribute("allow", "cross-origin-isolated; fullscreen"),
        D.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups allow-forms"),
        D.setAttribute("scrolling", "yes"),
        D.style.borderWidth = "0px",
        D.style.width = "100%",
        D.style.height = "100%",
        D.style.overflow = "auto",
        a.feedbackIframeOrigin = De(E);
        var T = document.createElementNS("http://www.w3.org/2000/svg", "svg");
        T.setAttribute("tabindex", "0"),
        T.setAttribute("role", "button"),
        T.setAttribute("aria-label", "Close feedback report"),
        T.style.position = "absolute",
        T.style.width = "26px",
        T.style.height = "26px",
        T.style.zIndex = "2147483647",
        T.style.cursor = "pointer",
        a.displayRtl ? T.style.left = "24px" : T.style.right = "24px",
        T.style.top = "24px",
        ...
        H.setAttribute("y1", "5"),
        H.setAttribute("y2", "18"),
        a.theme === mt.Light ? (M.setAttribute("stroke", "#0A0A0A"),
        H.setAttribute("stroke", "#0A0A0A")) : (M.setAttribute("stroke", "#F2F2F2"),
        ...
        a.wrapper.parentNode.appendChild(R),
      ...
      , rt = function(t) {
        ...
        if (o) {
            ...
            x("Unable to find feedback overlay cleanup handler. Removing overlay without cleanup."),
    ...
    function fa(e) {
        ...
        var t = function(i, o) {
            if (!i || i.tagName === "BODY")
                return o;
            for (var u = 1, s = i.previousElementSibling; s; )
                s.tagName === i.tagName && u++,
    ...
    function ma(e, t) {
        ...
        if (i) {
            ...
            var u = new Set, s, d = !0, p = !1, f = void 0;
            try {
    ...
    function ha(e, t, a, i) {
        for (var o = "", u = an(e) ? ma(e, i) : void 0, s = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT), d; (d = s.nextNode()) !== null && o.length < a; )
            if (!ga(d, u)) {
                for (var p = 0, f = d; f !== null && f !== e; )
                    p++,
                    f = f.parentNode;
                if (!(p > t))
    ...
    function ba() {
        for (var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : window, t = e; t && t.top !== t && !t.location.href.startsWith("http"); )
            t = t.top;
    ...
    function un(e, t, a) {
        ...
        (i == null ? void 0 : i.retryTimeout) !== void 0 && (window.clearTimeout(i.retryTimeout),
        i.retryTimeout = void 0),
        x("Cannot find Widget ".concat(a, ", consider using turnstile.remove() to clean up a widget.")),
        ...
        try {
            for (var u = e.widgetMap[Symbol.iterator](), s; !(a = (s = u.next()).done); a = !0) {
                ...
                if (!v || !f.shadow || !f.wrapper.isConnected) {
                    f.watchcat.missingWidgetWarning || (f.watchcat.missingWidgetWarning = !0,
                    t.push({
                        widgetElId: v,
                        widgetId: p
                    }));
                ...
                if (f.watchcat.seq = e.watchCatSeq,
                f.watchcat.lastAckedSeq === 0 && (f.watchcat.lastAckedSeq = e.watchCatSeq),
                !(f.isComplete || f.isFailed || f.feedbackOpen)) {
    ...
    function Ea(e) {
        ...
        try {
            for (var o = Object.getOwnPropertySymbols(e)[Symbol.iterator](), u; !(t = (u = o.next()).done); t = !0) {
                var s = u.value, d, p = (d = Object.getOwnPropertyDescriptor(e, s)) === null || d === void 0 ? void 0 : d.value;
    ...
    function wa(e, t) {
        ...
        d.src = s.toString();
        try {
            return i.parentNode.replaceChild(d, i),
            !0
        } catch (p) {
            if (!P(p, DOMException))
                throw p;
    ...
    function Ia(e, t, a) {
        ...
        return t.isReady = s.isReady,
        t.isRecaptchaCompatibilityMode = s.isRecaptchaCompatibilityMode,
        t.lastWidgetIdx = s.lastWidgetIdx,
        t.scriptWasLoadedAsync = s.scriptWasLoadedAsync,
        t.apiJsReloadBackoffMs = d ? Pe : fn(s),
        t.apiJsReloadNextAllowedTsMs = pn(s),
        t.apiJsMismatchReloadAttempts = (i = s.apiJsMismatchReloadAttempts) !== null && i !== void 0 ? i : 0,
        t.apiJsMismatchReloadCompletedCount = ((o = s.apiJsMismatchReloadCompletedCount) !== null && o !== void 0 ? o : 0) + (d ? 1 : 0),
        t.apiJsMismatchReloadPending = !1,
        t.upgradeAttempts = s.upgradeAttempts,
        t.upgradeCompletedCount = s.upgradeCompletedCount + 1,
        t.turnstileLoadInitTimeTsMs = $(),
        t.watchCatInterval = null,
        t.watchCatSeq = s.watchCatSeq,
        t.widgetMap = s.widgetMap,
        at(s, !0),
        s.msgHandler && window.removeEventListener("message", s.msgHandler),
        Ea(u),
        a(),
        !0
    }
        ...
        try {
            for (var o = m.widgetMap[Symbol.iterator](), u; !(t = (u = o.next()).done); t = !0) {
                var s = Ge(u.value, 2)
                  , d = s[0]
                  , p = s[1];
                if (p.wrapper.parentElement === e || p.wrapper !== e && p.wrapper.contains(e) || p.shadow.contains(e))
                    return d
            }
        } catch (f) {
            a = !0,
    ...
    function fr() {
        ot !== void 0 && (window.clearTimeout(ot),
        ot = void 0)
    }
    function Fa() {
        var e = !0
    ...
    function pr() {
        var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}
          ...
          , a = t === void 0 ? !1 : t;
        Nt = void 0,
        a || (m.apiJsMismatchReloadPending = !1),
        Ct !== void 0 && (window.clearTimeout(Ct),
        Ct = void 0)
    }
    function Da() {
        var e = Nt;
    ...
    function wn() {
        ...
        m.apiJsReloadNextAllowedTsMs = $() + a,
        m.apiJsReloadBackoffMs = Math.min(t * 2, Xe)
    }
    function In(e) {
        pr({
            preserveMismatchReloadPending: !0
        }),
        m.apiJsMismatchReloadPending = !0,
        Nt = e,
    ...
    function vr() {
        fr(),
        !Fa() && (ot = window.setTimeout(function() {
            ot = void 0,
            Va()
        }, Ur))
    }
    ...
    function Ua(e, t) {
        var a, i = (a = e.params["response-field"]) !== null && a !== void 0 ? a : !0, o = m.isRecaptchaCompatibilityMode, u = "".concat(t, "_response"), s = "".concat(t, "_g_response"), d = (!i || P(document.getElementById(u), HTMLInputElement)) && (!o || P(document.getElementById(s), HTMLInputElement));
        if (!(e.responseElementsBuilt && d)) {
            if (i && !P(document.getElementById(u), HTMLInputElement)) {
                var p, f = document.createElement("input");
                f.type = "hidden",
                f.name = (p = e.params["response-field-name"]) !== null && p !== void 0 ? p : Lr,
                f.id = u,
                e.wrapper.appendChild(f)
            }
    ...
    function Wa(e, t, a) {
        ...
        if (i !== null && P(i, HTMLInputElement) && (i.value = a),
    ...
    function It(e, t) {
        ...
        case ve.Managed:
            ...
            break;
        case ve.Invisible:
            Be("floating-invisible", t) ? (e.style.width = "0",
            e.style.height = "0",
            e.style.position = "absolute",
            e.style.visibility = "hidden") : (e.style.width = "1px",
            e.style.height = "1px",
    ...
    function An(e) {
        var t, a;
        return !((a = e.feedbackPopup) === null || a === void 0) && a.closed ? (e.feedbackPopup = void 0,
        e.feedbackPopupOrigin = void 0,
        null) : (t = e.feedbackPopup) !== null && t !== void 0 ? t : null
    }
    function Mt(e, t) {
    ...
    function Cn(e, t, a) {
        var i, o, u = (i = (o = Oe(t, a)) === null || o === void 0 ? void 0 : o.contentWindow) !== null && i !== void 0 ? i : null, s = Mt(t, a).targetWindow, d = function(f) {
    ...
    function Rt(e, t, a) {
        return e === null ? t : Ta(e) ? e === "true" : (x(a(e)),
        t)
    }
    function Mn() {
        try {
            ...
            try {
                for (var u = performance.getEntriesByType("resource")[Symbol.iterator](), s; !(a = (s = u.next()).done); a = !0) {
                    var d = s.value;
                    if (P(d, PerformanceResourceTiming) && d.name.includes(t))
                        return d
                }
            } catch (p) {
                i = !0,
    ...
    var Ba = (function() {
        var e = function(n, l, r, c, b, g) {
                ...
                return Rr(this, function(J) {
                    ...
                    case 0:
                        if (O = function(de, fe) {
                            ...
                            z !== n || z.isComplete || z.isResetting || z.response !== c || (!de && fe && x(fe),
                            o(z, r, de))
                        }
                        ,
                        w = n.params.sitekey,
                        ...
                        ne = "https",
                        ce = "",
                        te = "".concat(ne, "://").concat(ae.host, "/cdn-cgi/challenge-platform/").concat(W, "rc/").concat(g).concat(ce),
                        J.label = 1;
                    case 1:
                        return J.trys.push([1, 3, , 4]),
                        [4, fetch(te, {
                            body: JSON.stringify({
                                secondaryToken: b,
                                sitekey: w
                    ...
                    case 2:
                        return re = J.sent(),
                        re.status === 200 ? O(!0) : O(!1, "Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                        [3, 4];
                    case 3:
                        return Ce = J.sent(),
                        O(!1, "Error contacting Turnstile, aborting clearance redemption."),
                        [3, 4];
                    case 4:
                        return [2]
                    }
          ...
          , i = function(n, l, r) {
            if (n.feedbackOpen && (n.feedbackOpen = !1,
            n.feedbackPopupCloseCheck != null && (window.clearInterval(n.feedbackPopupCloseCheck),
            n.feedbackPopupCloseCheck = void 0),
            ra(),
            window.postMessage({
                event: "feedbackClose",
                source: j,
            ...
            n.pendingRetry)) {
                ...
                n.pendingRetry = void 0,
                t(n, l, c)
            }
        }
          , o = function(n, l, r) {
            var c;
            n.response === void 0 && h("[Internal Error] Widget was completed but no response was given", 1362),
            n.isExecuting = !1,
            n.isComplete = !0,
            Wa(n, l, n.response),
            (c = n.cbSuccess) === null || c === void 0 || c.call(n, n.response, r)
        }
          , u = function(n) {
            if (!n)
                return [];
            for (var l = n.attributes, r = l.length, c = new Array(r), b = 0; b < r; b++)
                c[b] = l[b].name;
            return c
        }
          , s = function() {
          ...
          , v = function(n, l) {
            if (l) {
                ...
                b.length > 0 && h("The parameters ".concat(r.join(","), " is/are not allowed be changed between the calls of render() and execute() of a widget.\n    Consider rendering a new widget if you want to change the following parameters ").concat(b.join(",")), 3618),
                l.action && (rr(l.action) || h('Invalid input for optional parameter "action", got "'.concat(l.action, '"'), 3604),
                n.action = l.action),
                l.cData && (ar(l.cData) || h('Invalid input for optional parameter "cData", got "'.concat(l.cData, '"'), 3605),
                n.cData = l.cData),
                l["after-interactive-callback"] && (n.cbAfterInteractive = l["after-interactive-callback"]),
                l["before-interactive-callback"] && (n.cbBeforeInteractive = l["before-interactive-callback"]),
                l.callback && (n.cbSuccess = l.callback),
                l["expired-callback"] && (n.cbExpired = l["expired-callback"]),
                l["timeout-callback"] && (n.cbTimeout = l["timeout-callback"]),
                l["error-callback"] && (n.cbError = l["error-callback"]),
                l["unsupported-callback"] && (n.cbUnsupported = l["unsupported-callback"]),
                l.chlPageData && (n.chlPageData = l.chlPageData)
            }
        }
          , E = function(n, l, r) {
            n === "explicit" && l && v(l, r),
          ...
          , A = function(n, l) {
            ...
            if (c) {
                ...
                c.errorCode = void 0,
                c.frMd = void 0,
                c.autoFeedbackSent = !1,
                c.watchcat.overrunBeginSeq = 0,
                c.watchcat.lastAckedSeq = 0,
                c.watchcat.seq = 0,
                a(c, n, k) && (c.msgQueue.push(ht.Execute),
                c.isExecuted = !0,
                c.isExecuting = !0);
                var O = Q(r)
                  , w = c.shadow.querySelector("#".concat(O));
                (!O || !w) && h("Widget ".concat(r, " to reset was not found."), 3330),
                (c.params.appearance === me.InteractionOnly || c.params.appearance === me.Execute) && La(w),
                c.params.sitekey === null && h("Unexpected Error: Sitekey is null", 3347);
                var L = w.cloneNode()
                  , W = Ht(r, c.params.sitekey, c.params, (b = c.rcV) !== null && b !== void 0 ? b : pe, !1, "g", n, m.scriptUrlParsed, Wt(c));
                L.src = W,
                Na(L, c),
                c.iframeOrigin = De(W),
                (g = w.parentNode) === null || g === void 0 || g.replaceChild(L, w),
                sr(c, O),
                c.retryTimeout && window.clearTimeout(c.retryTimeout)
            } else
                h("Widget ".concat(r, " to reset was not found."), 3331)
        }
          , I = function(n, l) {
            var r = Q(n);
            if (r) {
          ...
          , N = function(n, l, r) {
            var c, b, g, k, O, w, L, W, ae, ne, ce, te, re, Ce = $(), J, se;
            if (typeof n == "string") {
                var de = wt(n);
                if (de) {
                    var fe, z = m.widgetMap.get(de), Me = (fe = z == null ? void 0 : z.wrapper.parentElement) !== null && fe !== void 0 ? fe : null;
                    if (Me && Ca(r, z))
                        J = Me,
                        se = {
                            widget: z,
                    ...
                    xe || h('Unable to find a container for "'.concat(n, '"'), 3585),
                    J = xe
                }
            } else
                P(n, HTMLElement) ? J = n : h('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            if (!se) {
                var Ee = wt(J);
                if (Ee) {
                    var we = m.widgetMap.get(Ee);
                    if (we && Ca(r, we) && we.wrapper.parentElement === J)
                        se = {
                            widget: we,
                            widgetId: Ee
                        };
            ...
            var lt = dr();
            if (!lt)
                return h("Turnstile cannot determine its page location", 3607);
            var ut = Ln(J);
            if (ut) {
                var y = Object.assign(ut, l)
                  ...
                  , He = y.chlPageData
                  , ie = y.sitekey;
                y.theme = (c = y.theme) !== null && c !== void 0 ? c : mt.Auto,
                y.retry = (b = y.retry) !== null && b !== void 0 ? b : yt.Auto,
                y.execution = (g = y.execution) !== null && g !== void 0 ? g : Ke.Render,
                y.appearance = (k = y.appearance) !== null && k !== void 0 ? k : me.Always,
                y["retry-interval"] = Number((O = y["retry-interval"]) !== null && O !== void 0 ? O : Dr),
                y["expiry-interval"] = Number((w = y["expiry-interval"]) !== null && w !== void 0 ? w : (Tr - Ar) * 1e3),
                y.size = (L = y.size) !== null && L !== void 0 ? L : Y.Normal;
                var ct = y.callback
                ...
                typeof ie != "string" && h('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof ie == "undefined" ? "undefined" : F(ie), '"'), 3588),
                Ra(ie) || h('Invalid input for parameter "sitekey", got "'.concat(ie, '"'), 3589),
                nr(y.size) || h('Invalid type for parameter "size", expected normal|compact, got "'.concat(y.size, '" ').concat(F(y.size)), 3590),
                $t(y.theme) || h('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(y.theme, '" ').concat(F(y.theme)), 3591),
                Zt(y.retry) || h('Invalid type for parameter "retry", expected never|auto, got "'.concat(y.retry, '" ').concat(F(y.retry)), 3592),
                y.language || (y.language = "auto"),
                lr(y.language) || (x('Invalid language value: "'.concat(y.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")),
                y.language = "auto"),
                ur(y.appearance) || h('Unknown appearance value: "'.concat(y.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                cr(y.execution) || h('Unknown execution value: "'.concat(y.execution, ", expected either: 'render' or 'execute'."), 3601),
                er(y["retry-interval"]) || h('Invalid retry-interval value: "'.concat(y["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                tr(y["expiry-interval"]) || h('Invalid expiry-interval value: "'.concat(y["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                ...
                or(Ie) ? y["refresh-timeout"] = Ie : h('Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'.concat(Ie, '" ').concat(typeof Ie == "undefined" ? "undefined" : F(Ie)), 3603),
                rr(Ve) || h('Invalid input for optional parameter "action", got "'.concat(Ve, '"'), 3604),
                ar(Ne) || h('Invalid input for optional parameter "cData", got "'.concat(Ne, '"'), 3605);
                ...
                if (!(!ze || !st)) {
                    ...
                    Re || h("Turnstile Initialization Error ", 3606),
                    Re.chlPageData && fr(),
                    X.style.display = "none",
                    X.style.border = "none",
                    X.style.overflow = "hidden";
                    var hr = Ht(ze, ie, y, pe, !1, "g", K.New, m.scriptUrlParsed, Wt(Re));
                    Re.iframeOrigin = De(hr),
                    X.setAttribute("src", hr),
                    Na(X, Re);
                    var _r = ["cross-origin-isolated", "fullscreen", "autoplay", "keyboard-map", "gamepad", "xr-spatial-tracking"];
                    return q((ne = (re = document.featurePolicy) === null || re === void 0 || (te = re.features) === null || te === void 0 ? void 0 : te.call(re)) !== null && ne !== void 0 ? ne : [], Bt) && _r.push(Bt),
                    X.setAttribute("allow", _r.join("; ")),
                    X.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                    X.id = st,
                    X.tabIndex = (ce = y.tabindex) !== null && ce !== void 0 ? ce : 0,
                    X.title = "Widget containing a Cloudflare security challenge",
                    gr.appendChild(X),
                    Ua(Re, st),
                    se && I(se.widgetId, se.widget),
                    J.appendChild(_e),
                    Re.widgetRenderEndTimeTsMs = $(),
                    st
                }
            }
        }
          ...
          , ge = function() {
            var n = [Cr, Mr];
            m.isRecaptchaCompatibilityMode && n.push(Nr),
            document.querySelectorAll(n.join(", ")).forEach(function(l) {
                N(l, void 0, "implicit")
            })
        }
          , Z = function() {
            var n, l = -1, r = !0, c = !1, b = void 0;
            try {
            ...
            return l === -1 && h("Could not find widget", 43778),
            n
        }
          , D = Mn()
          , T = function(n) {
            if (n.source === j && !(!n.widgetId || !m.widgetMap.has(n.widgetId))) {
                ...
                if (!(!l || !r))
                    ...
                    case "init":
                        {
                            ...
                            c || h("Cannot initialize Widget, Element not found (#".concat(l, ")."), 3074),
                            r.mode = n.mode,
                            r.nextRcV = n.nextRcV,
                            r.mode === ve.Invisible && r.params["refresh-expired"] === Fe.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Fe.Auto, "' or '").concat(Fe.Never, ".'")),
                            r.mode !== ve.Managed && r.params["refresh-timeout"] !== Ye.Auto && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                            r.params.appearance === me.Always || r.isExecuting && r.params.appearance === me.Execute ? It(c, r) : La(c),
                            c.style.display = "";
                            var b = Oe(r, l);
                            b || h("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                            oe(b, {
                                event: "init",
                                source: j,
                                widgetId: n.widgetId
                    ...
                    case "translationInit":
                        {
                            ...
                            Object.keys(n.translationData).forEach(function(_e) {
                    ...
                    case "reject":
                        {
                            ...
                            if (r.isExecuting = !1,
                            O || h("Cannot initialize Widget, Element not found (#".concat(l, ")."), 3075),
                    ...
                    case "complete":
                        {
                            if (d(r, pe, n.widgetId),
                            r.response = n.token,
                            n.aC) {
                                var L;
                                (L = r.assetCtxCallback) === null || L === void 0 || L.call(r, n.aC)
                            }
                            if (n.scs && !Be("scs", r) && (r.scs = n.scs,
                            r.params["session-continuity-persist"] && !Be("scs_persist", r))) {
                    ...
                    case "fail":
                        {
                            ...
                            if (ce) {
                                var J;
                                ce(String((J = n.code) !== null && J !== void 0 ? J : Or)) ? re && r.params.retry === yt.Auto && !r.isResetting && t(r, l, te) : (n.code && x("Error: ".concat(n.code, ".")),
                                re && t(r, l, te))
                            } else
                                n.code ? (re && t(r, l, te),
                                h("Error: ".concat(n.code), 3076)) : t(r, l, !1);
                            break
                        }
                    case "feedbackInit":
                        {
                            ...
                            r.feedbackOpen = !0,
                            r.retryTimeout != null && (clearTimeout(r.retryTimeout),
                            r.retryTimeout = void 0,
                            r.pendingRetry || (r.pendingRetry = {
                                crashed: !1
                            })),
                            ta(),
                            window.postMessage({
                    ...
                    case "requestFeedbackData":
                        {
                            var fe = Oe(r, l);
                            fe || h("Received state for an unknown widget: #".concat(l, " / ").concat(n.widgetId), 3078),
                            oe(fe, {
                    ...
                    case "turnstileResults":
                        {
                            var z, Me, xe, Ee = Mt(r, l), we = Ee.targetOrigin, lt = Ee.targetWindow;
                            if (!lt)
                                break;
                            qt(lt, {
                    ...
                    case "closeFeedbackReportIframe":
                        {
                            ...
                            ut || h("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                            rt("".concat(l, "-fr")),
                            Ue(r),
                            i(r, l, n.widgetId);
                            break
                    ...
                    case "tokenExpired":
                        {
                            var y, Ve = n.token;
                            r.isExpired = !0,
                            (y = r.cbExpired) === null || y === void 0 || y.call(r, Ve),
                            r.params["refresh-expired"] === Fe.Auto && !r.isResetting && A(K.AutoExpire, l);
                            break
                        }
                    case "interactiveTimeout":
                        {
                            ...
                            sr(r, l);
                            var Ne = r.cbTimeout;
                            if (Ne ? Ne() : r.params["refresh-timeout"] === Ye.Never && !r.isResetting && x("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."),
                            r.params["refresh-timeout"] === Ye.Auto && !r.isResetting) {
                    ...
                    case "reloadApiJsRequest":
                        {
                            ...
                            Va() ? (m.apiJsMismatchReloadAttempts++,
                            wn(),
                            In(n.widgetId)) : it(n.widgetId);
                            break
                        }
                    case "interactiveBegin":
                        {
                            var ie, ct = r.shadow.getElementById(l);
                            ct || h("Cannot layout widget, Element not found (#".concat(l, ")."), 3076),
                            (ie = r.cbBeforeInteractive) === null || ie === void 0 || ie.call(r),
                            r.params.appearance === me.InteractionOnly && It(ct, r);
                            break
                        }
                    case "interactiveEnd":
                        {
                    ...
                    case "requestExtraParams":
                        {
                            ...
                            var qe = Oe(r, l);
                            qe || h("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                            r.isResetting = !1;
                            var Lt = {}
                              , Pt = $()
                              , Ft = {
          ...
          , ee = Ut(Te({}, H), {
            ...
            execute: function(n, l) {
                ...
                if (!r) {
                    ...
                    var b = S(n, l);
                    b || h("Failed to render widget", 43522),
                    r = (c = Ze(b)) !== null && c !== void 0 ? c : M(n),
                    r || h("Failed to render widget", 43522)
                }
                var g = m.widgetMap.get(r);
                if (g) {
                    v(g, l);
                    var k = Q(r);
                    if (k || (g.isExecuting = !1,
                    h("Widget ".concat(r, " to execute was not found"), 43522)),
                    g.isExecuting) {
                    ...
                    g.response) {
                        var O;
                        g.isExecuting = !1,
                        x("Call to execute() on a widget that was already executed (".concat(k, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                        (O = g.cbSuccess) === null || O === void 0 || O.call(g, g.response, !1);
                        return
                    }
                    g.isExpired && x("Call to execute on a expired-widget (".concat(k, "), consider using reset() before.")),
                    g.isStale && (A(K.StaleExecute, k),
                    g.isExecuting = !0),
                    (g.isResetting || !g.isInitialized) && g.msgQueue.push(ht.Execute),
                    g.isExecuted = !0;
                    var w = Oe(g, k);
                    if (w || (g.isExecuting = !1,
                    h("Widget ".concat(k, " to execute was not found"), 43522)),
                    g.isResetting || !g.isInitialized)
                        return;
                    if (g.isInitialized && g.msgQueue.length > 0) {
                        f(g, r, w),
                        g.params.appearance === me.Execute && It(w, g);
                        return
                    }
                    g.isInitialized && g.params.appearance === me.Execute && It(w, g),
                    g.isExecuting && oe(w, {
                        event: "execute",
                        source: j,
                        widgetId: r
            ...
            getResponse: function(n) {
                ...
                if (typeof n == "undefined") {
                    ...
                    if (r) {
                        var c = m.widgetMap.get(r);
                        return c != null && c.isExpired && x("Call to getResponse on a widget that expired, consider refreshing the widget."),
                        c == null ? void 0 : c.response
                    }
                    h("Could not find a widget", 43794)
                }
                var b = M(n);
                return b || h("Could not find widget for provided container", 43778),
                (l = m.widgetMap.get(b)) === null || l === void 0 ? void 0 : l.response
            },
            isExpired: function(n) {
                ...
                var k = M(n);
                return k || h("Could not find widget for provided container", 43778),
                (l = (r = m.widgetMap.get(k)) === null || r === void 0 ? void 0 : r.isExpired) !== null && l !== void 0 ? l : !1
            },
            ready: function(n) {
                if (m.scriptWasLoadedAsync && (x("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors."),
                h("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                typeof n != "function" && h('turnstile.ready() expected a "function" argument, got "'.concat(typeof n == "undefined" ? "undefined" : F(n), '"'), 3841),
                m.isReady) {
                    n();
                    return
                }
      ...
      , Tt = Ba.turnstile;
    function Ln(e) {
        var t, a, i = e.getAttribute("data-sitekey"), o = {
            sitekey: i
        ...
        if (d && (nr(d) ? o.size = d : x('Unknown data-size value: "'.concat(d, '".'))),
        0)
            var p;
        ...
        o["response-field"] = (a = Rt(e.getAttribute("data-response-field"), !0, function(_) {
        ...
        return typeof ee == "boolean" && (o["offlabel-show-help"] = ee),
        o
    }
    function Va() {
        if (fr(),
    ...
    Se = !1,
    B = Qr(),
    m.scriptWasLoadedAsync = (At = B == null ? void 0 : B.loadedAsync) !== null && At !== void 0 ? At : !1,
    m.scriptUrl = (St = B == null ? void 0 : B.src) !== null && St !== void 0 ? St : "undefined",
    m.scriptUrlParsed = B == null ? void 0 : B.url,
    B != null && B.params && (We = B.params.get("compat"),
    (We == null ? void 0 : We.toLowerCase()) === "recaptcha" ? window.grecaptcha ? x("grecaptcha is already defined. The compatibility layer will not be enabled.") : (x("Compatibility layer enabled."),
    m.isRecaptchaCompatibilityMode = !0,
    window.grecaptcha = Tt) : We !== null && x('Unknown value for api.js?compat: "'.concat(We, '", ignoring.')),
    B.params.forEach(function(e, t) {
        q(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t) || x('Unknown parameter passed to api.js: "?'.concat(t, '=...", ignoring.'))
    }),
    Se = B.params.get("_upgrade") === "true",
    le = B.params.get("onload"),
    le && !Se && setTimeout(function() {
        typeof ke[le] == "function" ? ke[le]() : (x("Unable to find onload callback '".concat(le, "' immediately after loading, expected 'function', got '").concat(F(ke[le]), "'.")),
        setTimeout(function() {
    ...
    ue = nt ? Oa(window.turnstile) : void 0,
    kt = nt && Se ? Ia(window.turnstile, m, function() {
        var e;
        window.turnstile = Tt,
        (e = Oa(Tt)) === null || e === void 0 || e.reloadAfterUpgrade(),
        Yt(m)
    }) : !1,
    kt && (ue == null || ue.clearPendingApiJsReloadRequest()),
    nt && Se && !kt ? (x("Turnstile upgrade state was missing. Keeping the existing Turnstile instance."),
    ue == null || ue.rejectPendingApiJsReloadRequest(),
    ue == null || ue.rearmTimedUpgrade()) : nt && !Se ? x("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (kt || (window.turnstile = Tt),
    Se || ((B == null || (Ot = B.params) === null || Ot === void 0 ? void 0 : Ot.get("render")) !== "explicit" && mr.push(Nn),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(Ma, 0) : window.addEventListener("DOMContentLoaded", Ma)),
    vr());
